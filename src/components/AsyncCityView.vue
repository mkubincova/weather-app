<template>
    <div class="flex flex-col flex-1 items-center">
        ...
        <div v-if="route.query.preview" class="text-white p-4 bg-weather-secondary w-full text-center">
            <p>You are currently previewing this city, click on "+" plus icon to save it.</p>
        </div>
            ...
            <div class="mx-8 text-white">
                ...
                <div v-for="day in weatherData.daily" :key="day.dt" class="flex items-center">
                    ...
                    <div class="flex gap-2 flex-1 justify-end">
                        <p class="text-lg">H: {{ Math.round(day.temp.max) }}&deg;</p>
                        <p class="text-lg">L: {{ Math.round(day.temp.min) }}&deg;</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="flex items-center gap-2 text-white cursor-pointer py-12 duration-150 hover:text-red-500"
            @click="removeCity">
